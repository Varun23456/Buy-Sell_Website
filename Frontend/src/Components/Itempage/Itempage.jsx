...
function Itempage({ item }) {
  ...
  useEffect(() => {
    const getSeller = async () => {
      try {
        let response = await axios.post("/api/getseller", { item }, {
  ...
  useEffect(() => {
    const checkitemFunc = async () => {
      try {
        let response = await axios.post("/api/checkitem", { item }, {
          withCredentials: true,
        });
  ...
  const handleAddToCart = async () => {
    try {
      let response = await axios.post("/api/addtocart", { item }, {
        withCredentials: true,
      });
  ...
  const handleRemoveFromCart = async () => {
    try {
      const response = await axios.post("/api/removefromcart", { myitem: item }, {
        withCredentials: true,
      });
