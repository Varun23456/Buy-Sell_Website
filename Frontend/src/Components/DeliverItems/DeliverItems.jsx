...
function deliverorders() {
    ...
    useEffect(() => {
        const getdeliverorders = async () => {
            try {
                setLoading(true);
                const response = await axios.post("/api/getdeliverorders", { message: 'getdeliverorders' }, {
                                                ...
                                                onClick={() => {
                                                    ...
                                                    const endtransaction = async () => {
                                                        try {
                                                            ...
                                                            const response = await axios.post("/api/endtransaction", { TransactionId, otp }, {
                                                                withCredentials: true,
                                                            });
                                            ...
                                            <button
                                                ...
                                                onClick={() => {
                                                    ...
                                                    const cancelorder = async () => {
                                                        try {
                                                            const response = await axios.post("/api/cancelorder", { TransactionId }, {
                                                                withCredentials: true,
                                                            });
